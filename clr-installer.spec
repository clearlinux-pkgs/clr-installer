...
Version  : 1.0.1
Release  : 3
URL      : https://github.com/clearlinux/clr-installer/archive/1.0.1.tar.gz
Source0  : https://github.com/clearlinux/clr-installer/archive/1.0.1.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1541546019
make  %{?_smp_mflags}
