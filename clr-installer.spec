...
Version  : 1.1.3
Release  : 10
URL      : https://github.com/clearlinux/clr-installer/archive/1.1.3.tar.gz
Source0  : https://github.com/clearlinux/clr-installer/archive/1.1.3.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1547054927
make  %{?_smp_mflags}
