...
Version  : 1.0.2
Release  : 4
URL      : https://github.com/clearlinux/clr-installer/archive/1.0.2.tar.gz
Source0  : https://github.com/clearlinux/clr-installer/archive/1.0.2.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1541791364
make  %{?_smp_mflags}
