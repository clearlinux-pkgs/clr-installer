...
Version  : 1.1.7
Release  : 17
URL      : https://github.com/clearlinux/clr-installer/archive/1.1.7.tar.gz
Source0  : https://github.com/clearlinux/clr-installer/archive/1.1.7.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1551925823
make  %{?_smp_mflags}
